export const weeklyHighlight = {
  ...
  chamada: 'Ryan Gosling no espaço, ciência virando aventura e uma amizade improvável para salvar o dia.',
  nota_sofahype: 94,
  nota_critica: 94,
  nota_publico: 95,
  hypometro: 'Sofá Galático',
  ...
  experiencia_extra: ['Ficção científica com emoção', 'Aventura espacial', 'Tem ciência, mas sem aula chata', 'Amizade improvável'],
  ideal_extra: ['ficção científica com coração', 'histórias de sobrevivência', 'aventura inteligente', 'Ryan Gosling resolvendo pepino impossível'],
  talvez_nao_extra: ['ação espacial o tempo todo', 'filme curto', 'história sem ciência', 'algo para assistir sem prestar atenção'],
